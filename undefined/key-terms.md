...
### **Data Autonomy Token ($DAT)**

The native token of the Vana Network is called $DAT. The token is used to pay for transaction fees (so-called gas fees) and will be generated by creating new blocks
